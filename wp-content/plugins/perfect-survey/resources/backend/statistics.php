        ...
        <tr>
          <td>
            <div class='survey-empty'>
              <div class="survey-no-data-effects">
                <img alt="no survey data" src="<?php echo esc_url( plugins_url( 'backend/assets/img/nofieldfound.png', dirname(__FILE__) ) ); ?>">
                <div class="survey-no-data-effects__wrapper">
                  <div class="survey-no-data-effects__light"></div>
                </div>
              </div>

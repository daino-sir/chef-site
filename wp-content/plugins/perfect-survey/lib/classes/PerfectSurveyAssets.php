...
class PerfectSurveyAssets extends PerfectSurveyCore
{
  ...
  */
  ...
  {
    prsv_register_css('survey-style', '/resources/frontend/assets/css/survey-frontend.css');
  }
  ...
  */
  ...
  public function init_frontend_scripts()
  {
    ...
    prsv_register_css('survey-style-front', '/resources/frontend/assets/css/survey-frontend.css');
    prsv_register_css('survey-style-css', '/resources/backend/assets/css/survey.css');
  ...
  */
  public function init_backend_scripts()
  {
    ...
    if ($screen->post_type == PRSV_POST_TYPE)
    {
      ...
      prsv_register_css('survey-style', '/resources/backend/assets/css/survey.css');
